...
fun Profile(){
    ...
    val circulo = painterResource(id = R.drawable.uvg)
    ...
    Column(horizontalAlignment = Alignment.CenterHorizontally)
    {
            ...
            modifier = Modifier.fillMaxWidth())
        {
            ...
            Image(painter = configur,
                contentDescription = "Settings logo", Modifier.absoluteOffset(-20.dp,30.dp))
        }
        ...
        Box (Modifier.fillMaxWidth().height(200.dp))
        {
            Image(painter = bgprofile,
                ...
                modifier = Modifier.height(150.dp).alpha(0.6f))

            Image(painter = circulo,
                contentDescription = "Circle",
                modifier = Modifier.size(150.dp).align(Alignment.Center).absoluteOffset(0.dp, 40.dp))
...
fun Menu(){
    ...
    val mygroups = painterResource(id = R.drawable.grupo)
    val grades = painterResource(id = R.drawable.curso)
    val schedule = painterResource(id = R.drawable.pendientes)
    val friends = painterResource(id = R.drawable.amigos)
    val courses = painterResource(id = R.drawable.notas)
    ...
    Column (Modifier.fillMaxWidth())
    {
        ...
        Row {
            ...
            Text(text = "Mis Amigos", style = TextStyle(color = Color.Black, fontSize = 20.sp), modifier = Modifier.padding(20.dp))
        }
        ...
        Row {
            ...
            Text(text = "Mi Calendario", style = TextStyle(color = Color.Black, fontSize = 20.sp), modifier = Modifier.padding(20.dp))
        }
        ...
        Row {
            ...
            Text(text = "Mis Cursos", style = TextStyle(color = Color.Black, fontSize = 20.sp), modifier = Modifier.padding(20.dp))
        }
        ...
        Row {
            ...
            Text(text = "Mis Calificaciones", style = TextStyle(color = Color.Black, fontSize = 20.sp), modifier = Modifier.padding(20.dp))
        }
        ...
        Row {
            ...
            Text(text = "Mis Grupos",
                style = TextStyle(color = Color.Black, fontSize = 20.sp), modifier = Modifier.padding(20.dp))
        }
